-- =============================================================================
-- MIGRATION: 20260216_add_descricao_me_cargo.sql
-- DESCRIÇÃO: 1. Adiciona coluna 'descricao' na tabela me_cargo
--            2. Atualiza a function criar_empresa_e_configuracoes_iniciais para usar
--               o nome correto da coluna (nome_cargo) e a nova coluna (descricao)
-- =============================================================================
...
-- 2. ATUALIZAR FUNÇÃO RPC (Versão corrigida e completa)
...
begin
    ...
    -- CORREÇÃO: Usar 'nome_cargo' e incluir 'descricao'
