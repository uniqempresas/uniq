-- =============================================================================
-- MIGRATION: 20260216_fix_me_categoria_pk.sql
-- DESCRIÇÃO: Correção do RETURNING na inserção de categorias.
--            A tabela me_categoria usa 'id_categoria' como PK, não 'id'.
-- =============================================================================
...
begin
    ...
    returning id_categoria into v_categoria_produtos_id; -- CORREÇÃO: id -> id_categoria

    insert into me_categoria (empresa_id, nome_categoria)
    values (v_empresa_id, 'Serviços')
    returning id_categoria into v_categoria_servicos_id; -- CORREÇÃO: id -> id_categoria
    ...
    (
        v_empresa_id, -- Faltava o serviço
