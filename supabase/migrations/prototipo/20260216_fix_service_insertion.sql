-- =============================================================================
-- MIGRATION: 20260216_fix_service_insertion.sql
-- DESCRIÇÃO: Separa a criação de produtos e serviços nas tabelas corretas.
--            Antes: Serviço Exemplo estava sendo inserido em me_produto.
--            Agora: Serviço Exemplo será inserido em me_servico.
-- =============================================================================
...
begin
    ...
    -- ===== 7. CRIAR SERVIÇOS INICIAIS (CORREÇÃO) =====
    insert into me_servico (
        empresa_id,
        categoria_id,
        nome_servico,
        descricao,
