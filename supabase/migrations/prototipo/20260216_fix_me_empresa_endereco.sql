-- =============================================================================
-- MIGRATION: 20260216_fix_me_empresa_endereco.sql
-- DESCRIÇÃO: Correção final (?) para a função de criação de empresa.
--            1. Ajusta inserção em me_empresa_endereco:
--               - 'estado' -> 'uf'
--               - Remove 'principal' (não existe na tabela)
--               - Adiciona 'ibge' (existe na tabela mas não estava sendo gravado)
-- =============================================================================
...
begin
    ...
    -- CORREÇÃO: Usar nome_cargo, descricao, ativo
    ...
    -- CORREÇÃO: Usar colunas corretas (role, nome_usuario, cargo)
    ...
    if p_cep is not null then
        insert into me_empresa_endereco (
            ...
            uf,
            ibge
            -- principal removido (não existe na tabela)
        )
        values (
            v_empresa_id,
            p_cep,
