-- =============================================================================
-- MIGRATION: 20260216_update_criar_empresa_rpc_v2.sql
-- DESCRIÇÃO: Correção do nome da coluna na tabela me_cargo (de 'nome' para 'nome_cargo')
-- =============================================================================
...
begin
    ...
    -- CORREÇÃO: Usar 'nome_cargo' ao invés de 'nome'
